				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">$'.$row['product_price'].'</h3> <br>
								<a class="product-name">'.$row['product_desc'].'</a>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">15 MARCH 2021, 8:0 PM</p>
													...
													<li>
														<div class="review-heading">
															...
															<p class="date">21 MARCH 2021, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">MITCH</h5>
															<p class="date">06 APRIL 2021, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
